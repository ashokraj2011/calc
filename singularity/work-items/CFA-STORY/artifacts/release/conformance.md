<!-- singularity-flow:metadata
{
  ...
  "authorship": {
    ...
    "source": {
      ...
      "sha256": "af0e7268fae202eba7c4efc4ebd5d47473018d963831c12bea53defa376ff049",
      "bytes": 2676
    },
    "generation": 1,
    "publishedAt": "2026-08-27T14:53:46.212Z"
  },
  "sourceCommit": "ec98672ea1cfc3fa8e342746e8467b6ea4e4ff1a",
  "generationCommit": "f9d3b64a7231332ba76e4ead5366fb7d2fc70c84",
  "publicationCommit": "f9d3b64a7231332ba76e4ead5366fb7d2fc70c84",
  ...
  "template": {
    "path": "singularity/templates/spec-driven/release.md",
    "sha256": "f091ec3cec891f0236a3a51a798dd43c401c992dfbcdc05b592eb119ebd2f692"
  },
  "inputs": {
    "generation": 1,
    "path": "singularity/work-items/CFA-STORY/context/inputs-release-gen1.json",
    "sha256": "e14d65d5b54141c4d5e46d459ef3e17697955018fc0b2100a3a72d2aefb7ca0f",
    "renderedSha256": "16668c82dbe732b6fd4c54a6d8be87c4f8514491ddf0197034e8ea2dc911d308",
    "mode": "enforce"
  },
  "designSources": {
    "sets": [],
  ...
  "telemetry": [
    {
      "generation": 1,
      "path": "singularity/work-items/CFA-STORY/telemetry/release-gen1.json",
      "sha256": "6ef53c43294d4e43407e07814916d9539a3d9db0529b3da70dddbceade32b9f2",
      "status": "not-invoked",
      "models": [],
      "providerCost": null
    }
  ...
  "approvals": [
    {
      ...
      "artifactSha256": [
        {
          "path": "singularity/work-items/CFA-STORY/artifacts/release/conformance.md",
          "sha256": "c239d3693e04c482cf862500d33c772d0e71d7a22628e4713e14f07ad575a7b2"
        },
        {
          "path": "singularity/work-items/CFA-STORY/artifacts/release/verification/evidence-index.md",
          "sha256": "b1f9dbb58c49e65ac72ae42077f5f0f47754390cd9ef64b613ee8b5888d0beb8"
        }
      ],
      "artifactSet": "spec-driven-verification",
      "bundleSha256": "88f04d8ac93e4c167e6e8149aae8365f33c45c04f6320f1e71c8d5afe6d71915",
      "reviewPacketSha256": "5e42723a4e56ca47707bb37ea62bc2adaca427f1d4c3654e9cf7c1ca0285e2c2",
      "evidenceCommit": "3f2e92c51fb9b01087fe18d38c4d1d1a5b376bc4",
      "artifactSetSha256": "0a5625997cecad66a5f735a35c0da9710cb1760a75e8aab10719450423fa6550",
      "actionContext": {
        "phase": "release",
        "label": "Release",
        "generation": 1,
        "submittedAt": "2026-08-27T15:00:36.877Z",
        "artifacts": [
          {
            "path": "singularity/work-items/CFA-STORY/artifacts/release/conformance.md",
            "sha256": "c239d3693e04c482cf862500d33c772d0e71d7a22628e4713e14f07ad575a7b2"
        ...
        "agentBriefs": [],
        "reviewPacketSha256": "5e42723a4e56ca47707bb37ea62bc2adaca427f1d4c3654e9cf7c1ca0285e2c2",
        "submittedSourceCommit": "f9d3b64a7231332ba76e4ead5366fb7d2fc70c84",
        "planId": "1ad2d1607362d994c1b69b0d"
      },
      "selfApproval": true
    }
  ],
...
The final human-readable trace is recorded below. Evidence lives below `verification/`; this
document says what it proves.

## Requirement trace

| Clause | Evidence | Verdict |
|---|---|---|
| [CFA-STORY:SPEC-001] / [CFA-STORY:AC-001] | `src/App.test.jsx` verifies the CFA entry point is reachable from the existing calculator navigation and remains in the app shell. | Pass |
| [CFA-STORY:SPEC-002] / [CFA-STORY:AC-002] | `src/App.test.jsx` verifies the nine required topic names are visible and selectable. | Pass |
| [CFA-STORY:SPEC-003] / [CFA-STORY:AC-003] | `src/App.test.jsx` and the recorded Vitest run verify valid current inputs produce a named calculation and visible result. | Pass |
| [CFA-STORY:SPEC-004] / [CFA-STORY:AC-004] | CFA acceptance coverage verifies invalid or incomplete values remain correction-ready and do not display a numeric result. | Pass |
| [CFA-STORY:SPEC-005] / [CFA-STORY:AC-005] | Calculator change and clear tests in `src/App.test.jsx` verify results update or clear when inputs change. | Pass |
| [CFA-STORY:SPEC-006] / [CFA-STORY:AC-006] | Automated CFA flow coverage keeps the selected topic, inputs, and result in the completed app state; no live screenshot was captured in the verification run. | Partial: automated evidence present; screenshot evidence outstanding |
| [CFA-STORY:NFR-001] | Verification evidence records the production-build timing measurement was not run. | Not evidenced |
| [CFA-STORY:NFR-002] | Existing automated UI coverage and shared component structure check accessibility-related behavior; no separate accessibility-tree inspection was captured. | Partial |
| [CFA-STORY:NFR-003] | The implementation is browser-local and has no backend or persistence surface; no browser network inspection was captured. | Partial |
| [CFA-STORY:NFR-004] | Responsive navigation tests passed; no desktop/mobile screenshot or overflow assertion was captured. | Partial |

## Constitution conformance

Each cited or evidence-required article, and its verdict. A model may propose evidence, but the
verdict for a judged article is recorded by a human authority.

| Article | Type | Verdict | Recorded by |
|---|---|---|---|
| None identified in the approved inputs | Constitution | No exception claimed | N/A |

## Exceptions

Every constitution exception, with article, reason, scope, authority, and expiry.

None. The approved verification evidence identifies residual evidence gaps, not constitution exceptions.

## Deviations

Accepted deviations carried from convergence, and the authority that accepted each.

None recorded in the approved convergence and verification inputs.
