...
|---|---|---|---|
| `WRK-1978:IFC-001` | `WRK-1978:AC-001` | TODO | planned |

## APIs, schemas, and contracts

The implementation MUST preserve or introduce the following exact contract: TODO. [WRK-1978:IFC-001]
...
The implementation MUST satisfy the security, observability, migration, and rollback obligations TODO. [WRK-1978:CON-002]
