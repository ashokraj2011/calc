# operations — light repository view

> Generated 29 August 2026 (2026-08-29T06:26:10.022Z) · deterministic light mode · source `b1599f5cc603081b1101feb48b680463780b8299`

## Observed

0 deployment/operations path(s) were indexed. Runtime topology and production state remain unknown.

- `.sflow/results/node-tests.json`
- `eslint.config.js`
- `package-lock.json`
- `package.json`
- `src/App.jsx`
